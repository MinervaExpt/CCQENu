...
\DoxyCodeLine{5 \textcolor{preprocessor}{\#include "{}CutFromConfig.h"{}}}
...
\DoxyCodeLine{19 PlotUtils::cuts\_t<UNIVERSE> GetCCQECutsFromConfig(NuConfig \& config )}
\DoxyCodeLine{20 \{}
...
\DoxyCodeLine{110 PlotUtils::constraints\_t<UNIVERSE> GetCCQEPhaseSpaceFromConfig(NuConfig \& config)}
\DoxyCodeLine{111 \{}
\DoxyCodeLine{112  }
\DoxyCodeLine{113 }
...
\DoxyCodeLine{165 PlotUtils::constraints\_t<UNIVERSE> GetCCQESignalFromConfig(NuConfig \& config)}
\DoxyCodeLine{166 \{}
