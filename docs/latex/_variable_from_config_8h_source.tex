...
\DoxyCodeLine{7 \textcolor{preprocessor}{\#include "{}include/MinervaUnfold/MnvResponse.h"{}}}
...
\DoxyCodeLine{38 }
\DoxyCodeLine{39 }
\DoxyCodeLine{40   \mbox{\hyperlink{class_c_c_q_e_nu_1_1_variable_from_config}{VariableFromConfig}}(\textcolor{keyword}{const} NuConfig config)\{}
