...
std::vector<CCQENu::Variable2DFromConfig*> Get2DVariablesVecFromConfig( std::vector<std::string> vars2D, std::vector<CCQENu::VariableFromConfig*> variablesvec, const std::vector<std::string> tags, NuConfig );
