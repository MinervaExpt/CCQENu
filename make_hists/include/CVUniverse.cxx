...
namespace {
  ...
  // double GetPperpMu(bool istruth=false) const {
  ...
  // double GetWgenie() const { return GetDouble("mc_w"); }
  ...
  // helper function
  bool CVUniverse::passTrueQELike(bool neutrinoMode, std::vector<int> mc_FSPartPDG, std::vector<double> mc_FSPartE, int mc_nFSPart, double proton_KECut) const {
    int genie_n_muons = 0;
  ...
  return CVUniverse::passTrueCCQELike(neutrinoMode,  mc_FSPartPDG, mc_FSPartE, mc_nFSPart, proton_KECut);
  }
  ...
  int CVUniverse::GetIsQELike() const{  // cut hardwired for now
    std::vector<int>mc_FSPartPDG = GetVecInt("mc_FSPartPDG");
    std::vector<double>mc_FSPartE = GetVecDouble("mc_FSPartE");
    ...
    int mc_incoming = GetInt("mc_incoming");
    int mc_current = GetInt("mc_current");
    bool passes = ( passTrueQELike(neutrinoMode, mc_FSPartPDG, mc_FSPartE, mc_nFSPart, NSFDefaults::TrueProtonKECutCentral));
  ...
  int CVUniverse::GetProtonCount() const {
    ...
    for(int i = 0; i < mc_nFSPart; i++){
      ...
      if( pdg == 2212 && KEp > proton_KECut) genie_n_protons++;
    }
