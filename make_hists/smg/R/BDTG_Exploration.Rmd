...
events <- events %>% 
  ...
  mutate(Particle_0 = case_when(PrimaryProtonCandidatePDG == 2212 ~ "Proton",
                              ...
                              !(PrimaryProtonCandidatePDG %in% c(321,-321,2212,1114,2214,2224,211,-211,111,-1,321,-321,1114,2214,2224)) ~ "Other"))

events <- events %>% mutate(Particle = Particle_0)
```
```{r, message = F, warning = F, echo = F, fig.height=7, fig.width=12}
n1 <- events %>% filter(Particle != "None") %>% filter(Truth != "qelike") %>% nrow()
n2 <- events %>% filter(BlobCount <= 1) %>% filter(ImprovedMichelCount == 0) %>% filter(Particle != "None") %>% filter(Truth != "qelike") %>% nrow()
1-n2/n1
n1 <- events %>% filter(Particle != "None") %>% filter(Truth == "qelike") %>% nrow()
n2 <- events %>% filter(BlobCount <= 1) %>% filter(ImprovedMichelCount == 0) %>% filter(Particle != "None") %>% filter(Truth == "qelike") %>% nrow()
n2/n1
```
```{r, message = F, warning = F, echo = F, fig.height=7, fig.width=12}
p1 <- ggplot(events %>% filter(Particle != "None"), aes(x = PrimaryProtonScore1, color = Particle, fill = Particle)) +
  geom_histogram(breaks = seq(0,1,0.05)) +
  scale_y_continuous(expand = expansion(mult = c(0, .05))) +
  scale_x_continuous(expand = c(0,0)) +
  theme_bw()

p2 <- ggplot(events %>% filter(Particle != "None"), aes(x = PrimaryProtonScore1, fill = Particle)) +
  geom_histogram(breaks = seq(0,1,0.05)) +
  scale_y_continuous(expand = expansion(mult = c(0, .05))) +
  scale_x_continuous(expand = c(0,0)) +
  theme_bw() +
...
p3 <- ggplot(events %>% filter(Particle != "None"), aes(x = PrimaryProtonScore1, fill = Particle)) +
  geom_histogram(breaks = seq(0,1,0.05)) +
  scale_y_continuous(expand = expansion(mult = c(0, .05))) +
  scale_x_continuous(expand = c(0,0)) +
  theme_bw() +
...
p4 <- ggplot(events %>% filter(Particle != "None"), aes(x = PrimaryProtonScore1, color = Particle, fill=Particle)) +
...
```
```{r, message = F, warning = F, echo = F, fig.height=7, fig.width=12}
p1 <- ggplot(events %>% filter(BlobCount <= 1) %>% filter(ImprovedMichelCount == 0) %>% filter(Particle != "None"), aes(x = PrimaryProtonScore1, color = Particle, fill = Particle)) +
  geom_histogram(breaks = seq(0,1,0.05)) +
  scale_y_continuous(expand = expansion(mult = c(0, .05))) +
  scale_x_continuous(expand = c(0,0)) +
  theme_bw()

p2 <- ggplot(events %>% filter(BlobCount <= 1) %>% filter(ImprovedMichelCount == 0) %>% filter(Particle != "None"), aes(x = PrimaryProtonScore1, fill = Particle)) +
  geom_histogram(breaks = seq(0,1,0.05)) +
  scale_y_continuous(expand = expansion(mult = c(0, .05))) +
  scale_x_continuous(expand = c(0,0)) +
  theme_bw() +
...
p3 <- ggplot(events %>% filter(BlobCount <= 1) %>% filter(ImprovedMichelCount == 0) %>% filter(Particle != "None"), aes(x = PrimaryProtonScore1, fill = Particle)) +
  geom_histogram(breaks = seq(0,1,0.05)) +
  scale_y_continuous(expand = expansion(mult = c(0, .05))) +
  scale_x_continuous(expand = c(0,0)) +
  theme_bw() +
...
p4 <- ggplot(events %>% filter(BlobCount <= 1) %>% filter(ImprovedMichelCount == 0) %>% filter(Particle != "None"), aes(x = PrimaryProtonScore1, color = Particle, fill=Particle)) +
  geom_histogram(breaks = seq(0,1,0.05), position = 'fill', aes(y=..count../sum(..count..))) +
  scale_y_continuous(expand = expansion(mult = c(0, .05))) +
  scale_x_continuous(expand = c(0,0)) +
  theme_bw()
