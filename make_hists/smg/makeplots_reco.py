...
for var in vars:
	...
	h_qelike = gROOT.FindObject( "h___Mult1p___qelike___"+var+"___reconstructed" )
	h_1chargedpion = gROOT.FindObject( "h___Mult1p___1chargedpion___"+var+"___reconstructed" )
	h_1neutralpion = gROOT.FindObject( "h___Mult1p___1neutralpion___"+var+"___reconstructed" )
	h_multipion = gROOT.FindObject( "h___Mult1p___multipion___"+var+"___reconstructed" )
	h_other = gROOT.FindObject( "h___Mult1p___other___"+var+"___reconstructed" )
	...
	##### >= 0.3 #####
	h_qelike_3 = gROOT.FindObject( "h___Mult1p03___qelike___"+var+"___reconstructed" )
	h_1chargedpion_3 = gROOT.FindObject( "h___Mult1p03___1chargedpion___"+var+"___reconstructed" )
	h_1neutralpion_3 = gROOT.FindObject( "h___Mult1p03___1neutralpion___"+var+"___reconstructed" )
	h_multipion_3 = gROOT.FindObject( "h___Mult1p03___multipion___"+var+"___reconstructed" )
	h_other_3 = gROOT.FindObject( "h___Mult1p03___other___"+var+"___reconstructed" )
	...
	############## Purity ##############
	h_pur = TH1F( 'purity', 'BDTG QELike Response >= 0.3 - Reconstructed', nbinX, array('f',xEdges))
	h_pur.SetLineColor(ROOT.kBlue+1)
	h_pur.SetFillColor(0)
	h_pur.SetStats(0)
	h_pur.SetXTitle("reconstructed "+var)
	...
	c1.cd()
	c1.SaveAs(var+'_Eff_Pur_Spec_for_Reco_cut_03.png')
	
	del legend, h_pur, h_eff, h_spec, c1
	del h_qelike_3, h_1chargedpion_3, h_1neutralpion_3, h_multipion_3, h_other_3
	
	##### >= 0.4 #####
	h_qelike_4 = gROOT.FindObject( "h___Mult1p04___qelike___"+var+"___reconstructed" )
	h_1chargedpion_4 = gROOT.FindObject( "h___Mult1p04___1chargedpion___"+var+"___reconstructed" )
	h_1neutralpion_4 = gROOT.FindObject( "h___Mult1p04___1neutralpion___"+var+"___reconstructed" )
	h_multipion_4 = gROOT.FindObject( "h___Mult1p04___multipion___"+var+"___reconstructed" )
	h_other_4 = gROOT.FindObject( "h___Mult1p04___other___"+var+"___reconstructed" )
	...
	############## Purity ##############
	h_pur = TH1F( 'purity', 'BDTG QELike Response >= 0.4 - Reconstructed', nbinX, array('f',xEdges))
	h_pur.SetLineColor(ROOT.kBlue+1)
	h_pur.SetFillColor(0)
	h_pur.SetStats(0)
	h_pur.SetXTitle("reconstructed "+var)
	...
	c1.cd()
	c1.SaveAs(var+'_Eff_Pur_Spec_for_Reco_cut_04.png')
