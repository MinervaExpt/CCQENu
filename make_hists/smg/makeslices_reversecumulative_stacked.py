...
title = "Reverse Cumulative | 2track | "+str(lows[bin_i])+" #leq "+"Q_{2}QE"+" < "+str(highs[bin_i])
...
cc.RedrawAxis()
cc.Draw()
cc.Print("SB_NuConfig_bdtg_MAD_2track_me1N_1_testing/bdtgQELike_reversecumulative_proportional_"+str(bin_i)+".png")
cc.Close()
