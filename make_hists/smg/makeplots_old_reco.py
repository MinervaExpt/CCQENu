...
for var in vars:
	...
	##### >= 0.3 #####
	h_qelike_QE = gROOT.FindObject( "h___QElike_Mult1p___qelike___"+var+"___reconstructed" )
	h_1chargedpion_QE = gROOT.FindObject( "h___QElike_Mult1p___1chargedpion___"+var+"___reconstructed" )
	h_1neutralpion_QE = gROOT.FindObject( "h___QElike_Mult1p___1neutralpion___"+var+"___reconstructed" )
	h_multipion_QE = gROOT.FindObject( "h___QElike_Mult1p___multipion___"+var+"___reconstructed" )
	h_other_QE = gROOT.FindObject( "h___QElike_Mult1p___other___"+var+"___reconstructed" )
	...
	############## Purity ##############
	h_pur = TH1F( 'purity', 'Traditional Cuts - Reconstructed', nbinX, array('f',xEdges))
	...
	c1.SaveAs(var+'_Eff_Pur_Spec_for_Reco_old.png')
