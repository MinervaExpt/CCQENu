...
for let in playlists:
	mc_playlist = "/home/sean/Minerva/data/playlists/local/minervame1"+let+"_p4_MC.txt"
	data_playlist = "/home/sean/Minerva/data/playlists/local/minervame1"+let+"_p4_Data.txt"
	...
	pots[let] = [x_mc,x_data]

print("   : MC                    : Data                   : Ratio")
for let in playlists:
	print(" ",let," : ",pots[let][0]," : ",pots[let][1]," : ",pots[let][0]/pots[let][1],sep="")
=======
...
print("\end{tabular}")
print("\end{center}")
>>>>>>> c88127075ab1dfad16ddd411c0ab1c5908a8580b
