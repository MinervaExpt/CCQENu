...
#dir = "/Users/schellma/Dropbox/ccqe/Amit/v33"
dir = "/Users/schellma/Dropbox/ccqe/v27"
mcdir = dir
...
oname =  "chi2-%s-%s_v15.tex"%(basemodel,var)
...
for model in models:
  ...
  for syst in sysnames:
    ...
    if var != "pzmu_ptmu" and syst == "ALL":
      ...
      mcdraw[model].Write()
      pname =  basemodel+"%s-%s-lowq2_v15.pdf" %(var,model)
