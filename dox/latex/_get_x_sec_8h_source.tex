...
\DoxyCodeLine{441       NuConfig* config = configs[\textcolor{stringliteral}{"{}main"{}}];}
...
\DoxyCodeLine{515                       NuConfig oneconfig, TCanvas \& canvas, \textcolor{keywordtype}{double} norm, \textcolor{keywordtype}{double} POTScale, \textcolor{keyword}{const} MnvH1D* h\_flux\_dewidthed,}
...
\DoxyCodeLine{542     NuConfig sigkey = configs[\textcolor{stringliteral}{"{}main"{}}]-\/>GetConfig(\textcolor{stringliteral}{"{}signal"{}});}
...
\DoxyCodeLine{546     NuConfig bkgkey;}
...
\DoxyCodeLine{555     \}}
\DoxyCodeLine{556     NuConfig datkey = configs[\textcolor{stringliteral}{"{}main"{}}]-\/>GetConfig(\textcolor{stringliteral}{"{}data"{}});}
...
\DoxyCodeLine{829           NuConfig* vars = \textcolor{keyword}{new} NuConfig();}
...
\DoxyCodeLine{887                                      NuConfig mainconfig, TCanvas \& canvas, \textcolor{keywordtype}{double} norm, \textcolor{keywordtype}{double} POTScale, \textcolor{keyword}{const} MnvH1D* h\_flux\_dewidthed,}
...
\DoxyCodeLine{893                                      NuConfig mainconfig, TCanvas \& canvas, \textcolor{keywordtype}{double} norm, \textcolor{keywordtype}{double} POTScale, \textcolor{keyword}{const} MnvH1D* h\_flux\_dewidthed,}
