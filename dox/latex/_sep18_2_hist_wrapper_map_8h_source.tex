\hypertarget{_sep18_2_hist_wrapper_map_8h_source}{}\doxysection{Hist\+Wrapper\+Map.\+h}
\label{_sep18_2_hist_wrapper_map_8h_source}\index{make\_hists/include/Sep18/HistWrapperMap.h@{make\_hists/include/Sep18/HistWrapperMap.h}}
...
\DoxyCodeLine{27 }
\DoxyCodeLine{28 \textcolor{keyword}{class }HistWrapperMap:\textcolor{keyword}{public} T \{}
\DoxyCodeLine{29 }
...
\DoxyCodeLine{55 }
\DoxyCodeLine{56   HistWrapperMap()\{\};}
\DoxyCodeLine{57   \textcolor{comment}{// constructor}}
\DoxyCodeLine{58 }
\DoxyCodeLine{59 }
\DoxyCodeLine{60 }
\DoxyCodeLine{61   \textcolor{keyword}{inline}  HistWrapperMap( \textcolor{keyword}{const} std::string name, \textcolor{keyword}{const} std::string title, \textcolor{keyword}{const} Int\_t nbins, \textcolor{keyword}{const} \textcolor{keywordtype}{double} xmin,\textcolor{keyword}{const} \textcolor{keywordtype}{double} xmax,  std::map< std::string,std::vector<T*>> univs, \textcolor{keyword}{const} std::vector<std::string> tags)\{}
...
\DoxyCodeLine{126   \textcolor{keyword}{inline}  HistWrapperMap( \textcolor{keyword}{const} std::string name, \textcolor{keyword}{const} std::string title, \textcolor{keyword}{const} Int\_t nbins, \textcolor{keyword}{const} std::vector<double> bins,  std::map< std::string, std::vector<T*> > univs, std::vector<std::string> tags)\{}
...
\DoxyCodeLine{148     \textcolor{keyword}{inline}  HistWrapperMap( \textcolor{keyword}{const} std::string name, \textcolor{keyword}{const} std::string title, \textcolor{keyword}{const} Int\_t nbins, \textcolor{keyword}{const} std::vector<double> bins, \textcolor{keyword}{const} Int\_t nrecobins, \textcolor{keyword}{const} std::vector<double> recobins, std::map< std::string, std::vector<T*> > univs, std::vector<std::string> tags)\{}
...
\DoxyCodeLine{225   \textcolor{keyword}{inline} \textcolor{keywordtype}{void} Fill(\textcolor{keyword}{const} std::string tag, \textcolor{keyword}{const} T* universe, \textcolor{keyword}{const} Double\_t value, \textcolor{keyword}{const} Double\_t weight=1.0, \textcolor{keyword}{const} Double\_t scale=1.0)\{}
\DoxyCodeLine{226     m\_hists[tag].FillUniverse(universe, value, weight*scale);}
\DoxyCodeLine{227   \}}
\DoxyCodeLine{228 }
...
\DoxyCodeLine{233     m\_response[tag]-\/>Fill(value, truth, name, iuniv, weight*scale);}
\DoxyCodeLine{234   \}}
\DoxyCodeLine{235 }
