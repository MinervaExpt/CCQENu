...
\DoxyCodeLine{16 }
\DoxyCodeLine{17 \textcolor{keyword}{class }Variable2DFromConfig : \textcolor{keyword}{public} PlotUtils::Variable2DBase<CVUniverse> \{}
\DoxyCodeLine{18 \textcolor{keyword}{private}:}
\DoxyCodeLine{19   \textcolor{keyword}{typedef} \mbox{\hyperlink{class_plot_utils_1_1_hist2_d_wrapper_map}{PlotUtils::Hist2DWrapperMap<CVUniverse>}} HM2D;}
\DoxyCodeLine{20 }
...
\DoxyCodeLine{35 }
\DoxyCodeLine{36   Variable2DFromConfig(\textcolor{keyword}{const} std::string name,}
...
\DoxyCodeLine{39   PlotUtils::Variable2DBase<\mbox{\hyperlink{class_c_v_universe}{CVUniverse}}>(name, x, y )\{}
...
\DoxyCodeLine{44   \};}
\DoxyCodeLine{45 }
\DoxyCodeLine{46   Variable2DFromConfig(\textcolor{keyword}{const} VariableBase<CVUniverse>\& x,}
\DoxyCodeLine{47                        \textcolor{keyword}{const} VariableBase<CVUniverse>\& y) :}
\DoxyCodeLine{48   PlotUtils::Variable2DBase<\mbox{\hyperlink{class_c_v_universe}{CVUniverse}}>(x, y )\{}
...
\DoxyCodeLine{53   \};}
\DoxyCodeLine{54 }
\DoxyCodeLine{55   Variable2DFromConfig(\textcolor{keyword}{const} std::string name,}
...
\DoxyCodeLine{59   PlotUtils::Variable2DBase<\mbox{\hyperlink{class_c_v_universe}{CVUniverse}}>(name, x, y)\{}
...
\DoxyCodeLine{69   \};}
\DoxyCodeLine{70 }
\DoxyCodeLine{71   Variable2DFromConfig(\textcolor{keyword}{const} std::string name,}
...
\DoxyCodeLine{75   PlotUtils::Variable2DBase<\mbox{\hyperlink{class_c_v_universe}{CVUniverse}}>(name, x, y)\{}
...
\DoxyCodeLine{114 }
\DoxyCodeLine{115   HM2D m\_selected\_mc\_reco;}
\DoxyCodeLine{116   HM2D m\_tuned\_mc\_reco; \textcolor{comment}{// HM for tuned MC hists used for background subtraction -\/NHV}}
\DoxyCodeLine{117   HM2D m\_selected\_mc\_truth;}
\DoxyCodeLine{118   HM2D m\_tuned\_selected\_mc\_truth;}
\DoxyCodeLine{119   HM2D m\_signal\_mc\_truth;}
\DoxyCodeLine{120   HM2D m\_tuned\_signal\_mc\_truth;}
\DoxyCodeLine{121   HM2D m\_selected\_data;}
...
\DoxyCodeLine{175 }
\DoxyCodeLine{176     m\_selected\_mc\_reco = HM2D(Form(\textcolor{stringliteral}{"{}\%s"{}},GetName().c\_str()), (GetName()+\textcolor{stringliteral}{"{};"{}}+m\_xaxis\_label+\textcolor{stringliteral}{"{};"{}}+m\_yaxis\_label).c\_str(), xbins, ybins, univs, tags); \textcolor{comment}{//Hist2DWrapper doesn't need nbins for variable binning}}
...
\DoxyCodeLine{200 }
\DoxyCodeLine{201     m\_selected\_mc\_truth = HM2D(Form(\textcolor{stringliteral}{"{}\%s"{}}, GetName().c\_str()), (GetName()+\textcolor{stringliteral}{"{};"{}}+m\_xaxis\_label+\textcolor{stringliteral}{"{};"{}}+m\_yaxis\_label).c\_str(), xbins, ybins, univs, tags); \textcolor{comment}{//Hist2DWrapper doesn't need nbins for variable binning}}
...
\DoxyCodeLine{226 }
\DoxyCodeLine{227 }
\DoxyCodeLine{228     m\_signal\_mc\_truth = HM2D(Form(\textcolor{stringliteral}{"{}\%s"{}}, GetName().c\_str()), (GetName()+\textcolor{stringliteral}{"{};"{}}+m\_xaxis\_label+\textcolor{stringliteral}{"{};"{}}+m\_yaxis\_label).c\_str(), xbins, ybins, univs, tags);}
...
\DoxyCodeLine{250 }
\DoxyCodeLine{251     m\_selected\_data = HM2D(Form(\textcolor{stringliteral}{"{}\%s"{}}, GetName().c\_str()), (GetName()+\textcolor{stringliteral}{"{};"{}}+m\_xaxis\_label+\textcolor{stringliteral}{"{};"{}}+m\_yaxis\_label).c\_str(), xbins, ybins, univs, tags); \textcolor{comment}{//Hist2DWrapper doesn't need nbins for variable binning}}
...
\DoxyCodeLine{272       m\_tuned\_mc\_reco = HM2D(Form(\textcolor{stringliteral}{"{}\%s"{}}, GetName().c\_str()), (GetName()+\textcolor{stringliteral}{"{};"{}}+m\_xaxis\_label+\textcolor{stringliteral}{"{};"{}}+m\_yaxis\_label).c\_str(), xbins, ybins, reco\_univs, tuned\_tags);}
...
\DoxyCodeLine{276       m\_tuned\_selected\_mc\_truth = HM2D(Form(\textcolor{stringliteral}{"{}\%s"{}}, GetName().c\_str()), (GetName()+\textcolor{stringliteral}{"{};"{}}+m\_xaxis\_label+\textcolor{stringliteral}{"{};"{}}+m\_yaxis\_label).c\_str(), xbins, ybins, reco\_univs, tuned\_tags);}
...
\DoxyCodeLine{280       m\_tuned\_signal\_mc\_truth = HM2D(Form(\textcolor{stringliteral}{"{}\%s"{}}, GetName().c\_str()), (GetName()+\textcolor{stringliteral}{"{};"{}}+m\_xaxis\_label+\textcolor{stringliteral}{"{};"{}}+m\_yaxis\_label).c\_str(), xbins, ybins, truth\_univs, tuned\_tags);}
