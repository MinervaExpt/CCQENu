...
\DoxyCodeLine{11 }
\DoxyCodeLine{12 \textcolor{preprocessor}{\#include "{}include/CVUniverse.h"{}}}
...
\DoxyCodeLine{33 UniverseMap GetStandardSystematics(PlotUtils::ChainWrapper* chain, \textcolor{keyword}{const} \mbox{\hyperlink{class_nu_config}{NuConfig}} config, \textcolor{keywordtype}{bool} is\_truth = \textcolor{keyword}{false}) \{}
