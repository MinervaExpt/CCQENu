...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/xsec/DPF26/newfitting_p8_multipion_100flux/${MYMODEL}/datareco/ \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/xsec/DPF26/newfitting_p8_multipion_100flux/${MYMODEL}/truth/ \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/xsec/DPF26/newfitting_p8_no_multipion_100flux/${MYMODEL}/datareco/ \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/xsec/DPF26/newfitting_p8_no_multipion_100flux/${MYMODEL}/truth/ \
