...
# python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/July2026/xsec/DPF26/newfitting_p8_multipion_100flux/${MYMODEL}/datareco_fix/ \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/July2026/xsec/removal_noqeband_100flux/${MYMODEL}/datareco_fix/ \
