...
# this version runs on the mac to test thing out.  Will not actually submit anything
export CVSROOT=minervacvs@cdcvs.fnal.gov:/cvs/mnvsoft
echo "Startup for root jobs"
...
export MPARAMFILESROOT=$BASEDIR/opt/etc/MParamFiles
