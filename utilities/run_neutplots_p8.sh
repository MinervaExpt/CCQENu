...
# ============== onetrack
# allblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/1trackonly_AllBlobs/twodim \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/1trackonly_AllBlobs/onedim \
...
# 2dblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/1trackonly_2donly/twodim \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/1trackonly_2donly/onedim \
...
# 3dblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/1trackonly_3donly/twodim \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/1trackonly_3donly/onedim \
...
# ============== twotrack
# allblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/2trackonly_AllBlobs/twodim \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/2trackonly_AllBlobs/onedim \
...
# 2dblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/2trackonly_2donly/twodim \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/2trackonly_2donly/onedim \
...
# 3dblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/2trackonly_3donly/twodim \
...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/June2026/blobstudy_fixed/${MYMODEL}/allblobcuts/2trackonly_3donly/onedim \
