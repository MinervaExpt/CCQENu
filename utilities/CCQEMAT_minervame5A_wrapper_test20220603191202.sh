...
#cmd: 	$CCQEMAT/sidebands_v2 /Users/schellma/Dropbox/TOPMAT/CCQENu/make_hists/hms/testmac 1000 >& sidebands.log

$CCQEMAT/sidebands_v2 /Users/schellma/Dropbox/TOPMAT/CCQENu/make_hists/hms/testmac 1000 >& sidebands.log
...
#cmd: 	echo "ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603191202"

echo "ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603191202"

#cmd: 	ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603191202

ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603191202

#cmd: 	echo "ifdh returned " $?

echo "ifdh returned " $?

#cmd: 	echo "ifdh cp -D sidebands_test20220603191202.log /Users/schellma/tmp//test/test20220603191202"

echo "ifdh cp -D sidebands_test20220603191202.log /Users/schellma/tmp//test/test20220603191202"

#cmd: 	ifdh cp -D sidebands.log /Users/schellma/tmp//test/test20220603191202

ifdh cp -D sidebands.log /Users/schellma/tmp//test/test20220603191202
