...
#cmd: 	$CCQEMAT/sidebands_v2 /Users/schellma/Dropbox/TOPMAT/CCQENu/make_hists/hms/testmac 1000 >& sidebands_test20220603192016.log

$CCQEMAT/sidebands_v2 /Users/schellma/Dropbox/TOPMAT/CCQENu/make_hists/hms/testmac 1000 >& sidebands_test20220603192016.log
...
#cmd: 	echo "ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603192016"

echo "ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603192016"

#cmd: 	ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603192016

ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603192016

#cmd: 	echo "ifdh returned " $?

echo "ifdh returned " $?

#cmd: 	echo "ifdh cp -D sidebands_test20220603192016.log /Users/schellma/tmp//test/test20220603192016"

echo "ifdh cp -D sidebands_test20220603192016.log /Users/schellma/tmp//test/test20220603192016"

#cmd: 	ifdh cp -D sidebands.log /Users/schellma/tmp//test/test20220603192016

ifdh cp -D sidebands.log /Users/schellma/tmp//test/test20220603192016
