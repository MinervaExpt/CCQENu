...
# ============== onetrack
# allblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/August2026/blobstudy_fixed/${MYMODEL}/vtxdistcut/1trackonly_AllBlobs/twodim \
...
# 2dblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/August2026/blobstudy_fixed/${MYMODEL}/vtxdistcut/1trackonly_2donly/twodim \
...
# 3dblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/August2026/blobstudy_fixed/${MYMODEL}/vtxdistcut/1trackonly_3donly/twodim \
...
# ============== twotrack
# allblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/August2026/blobstudy_fixed/${MYMODEL}/vtxdistcut/2trackonly_AllBlobs/twodim \
...
# 2dblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/August2026/blobstudy_fixed/${MYMODEL}/vtxdistcut/2trackonly_2donly/twodim \
...
# 3dblobs
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/August2026/blobstudy_fixed/${MYMODEL}/vtxdistcut/2trackonly_3donly/twodim \
