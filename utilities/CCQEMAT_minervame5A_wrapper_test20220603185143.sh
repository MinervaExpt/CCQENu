...
#cmd: 	\$CCQEMAT/sidebands_v2 $CCQEMAT/testmac 1000 >& sidebands.log

$CCQEMAT/sidebands_v2 $CCQEMAT/testmac 1000 >& sidebands.log
...
#cmd: 	\echo "ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603185143"

echo "ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603185143"

#cmd: 	\ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603185143

ifdh cp -D ./*.root /Users/schellma/tmp//test/test20220603185143

#cmd: 	\echo "ifdh returned " $?

echo "ifdh returned " $?

#cmd: 	\echo "ifdh cp -D sidebands_test20220603185143.log /Users/schellma/tmp//test/test20220603185143"

echo "ifdh cp -D sidebands_test20220603185143.log /Users/schellma/tmp//test/test20220603185143"

#cmd: 	\ifdh cp -D sidebands.log /Users/schellma/tmp//test/test20220603185143

ifdh cp -D sidebands.log /Users/schellma/tmp//test/test20220603185143
