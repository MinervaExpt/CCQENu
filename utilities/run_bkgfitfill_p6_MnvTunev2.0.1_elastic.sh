...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/bkgfitting/eventloopout/February2026/bkgfitting/fitfill_bkgfit_200flux_${MYMODEL} \
