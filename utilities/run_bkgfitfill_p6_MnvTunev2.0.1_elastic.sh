...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/May2026/bkgfitting/${MYMODEL}/Rebin_fix_geanthadroncv_fitfill_bkgfit_200flux_p6_${MYMODEL} \
