python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/test \
 ...
 --mail --prescale=1 --config=smg/config/main/NuConfig_bdtg_1track_MultiPionCut_me1F_7of15 --exe=sidebands_v2 --sample=1track_MultiPionCut --setup=CCQENu/utilities/setup_batch_al9.sh \
