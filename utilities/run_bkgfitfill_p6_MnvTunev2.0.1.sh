...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/eventloopout/May2026/bkgfitting/${MYMODEL}/Test_FinerBins_NoSyst_fix_geanthadroncv_bkgfit_p6_${MYMODEL} \
