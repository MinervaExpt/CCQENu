...
python $WHEREIPUTMYCODE/CCQENu/utilities/SubmitJobsToGrid_MAT.py --stage=CCQEMAT --outdir=$SCRATCH/test \
 --basedir=$WHEREIPUTMYCODE --rundir=CCQENu/make_hists --playlist=5A --model=MnvTunev2 --tag=AL9-p7 \
 --mail --prescale=100 --config=p7_run --exe=sidebands_v2 --sample=QElike --setup=CCQENu/utilities/setup_batch_al9_proto.sh \
